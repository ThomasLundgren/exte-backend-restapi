...
public class LDAP {
	...
	/**
	 * Authenticates a user via the HiG LDAP server. All code is taken from the VFU Socionom project.
	 * @param userId The ID of the user.
	 * @param password The passed in password.
	 * @return True if the authentication succeeded, false if the authentication failed.
	 */
