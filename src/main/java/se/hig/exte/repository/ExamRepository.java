...
public interface ExamRepository extends JpaRepository<Exam, Integer> {
	...
	/**
	 * Fetches all {@link Exam} objects which belong to the specified {@link Course}
	 * from the database.
	 * 
	 * @param courseId The ID of the {@link Course}.
	 * @return A {@link List} containing all {@link Exam}s belonging to the
	 *         {@link Course} with the specified ID.
	 */
	 ...
	 * 
	 * @return A {@link List} containing all {@link Exam}s with the unpublished
	 *         value set to true.
	 */
	...
	/**
	 * Fetches all {@link Exam} objects that have an expired unpublish date and
	 * haven't already been flagged as unpublished.
	 * 
